...
class ad_calc_search(unittest.TestCase):
    ...
    def test_case(self, query):
        ...
        #
        #for i in range(0, 5):
        #    new_result = run_for_search_category(new_url)[0]    #字典，旧版本的所有数据，包含ad_id，DebugAdInfo，debug_info，bid_ctr，score，search_type
        #    if len(new_result) > 0:
        #        break
        #    else:
        #        time.sleep(1)
...
if __name__ == "__main__":
    ...
    runner = HTMLTestRunner.HTMLTestRunner(
        stream=fp,
        title=u'搜索页计算模块--百货query新老产品版本结果比对_APP',
