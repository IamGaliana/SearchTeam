...
test_report = u"\\\\ddfile\\技术部\\测试部\\广告系统\\自动化测试报告\\search\\"+title+u"ad_calc_search_nbook_compare.html"
test_log = u"\\\\ddfile\\技术部\\测试部\\广告系统\\自动化测试报告\\search\\"+title+u"ad_calc_search_nbook_compare.txt"
