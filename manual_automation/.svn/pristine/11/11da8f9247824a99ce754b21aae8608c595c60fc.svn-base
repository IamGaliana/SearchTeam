...
class PagesElements(object):
    ...
    class LogInPage(object):
        ...
        GYS_ID = "id->gysbh"
        OPERATOR = "xpath->.//*[@id='login_form']/.//input[@name='czybh']"
        DDUSER = "id->ddusername"
    ...
    class CreateSearchAdPage(object):
        ADD_CURRENT_PAGE_ALL_KEYWORDS = "xpath->.//a[contains(text(),'添加当前页')]"
        KEYWORD_EDIT_INPUT = "id->kw_left"
