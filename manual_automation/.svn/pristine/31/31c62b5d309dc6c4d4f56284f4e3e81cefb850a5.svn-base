...
public class DupliScheduler {
	...
	public void clearup() {
		...
		content.append(String.format("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>", "搜索结果页去重DupliScheduler", pass, fail, 0, pass + fail
				+ 0));
		...
		if(pr < 100){
			warnContent.append(String.format("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>", 
					"搜索结果页去重DupliScheduler", pass, fail, 0, pass+fail, "0.00%", pr + "%", "100.00%"));
