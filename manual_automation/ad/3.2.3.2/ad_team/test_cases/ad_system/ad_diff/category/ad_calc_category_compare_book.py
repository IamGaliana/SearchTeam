...
class ad_calc_category(unittest.TestCase):
    def setUp(self):
        self.URL_NEW = "http://10.3.255.91:9080/getAds/cpc/6/0/50/%s/3232262672/20141022092715613302051844096892271/0/0/0/1/%s/0/0/0/0/debug"
        self.URL_OLD = "http://10.3.255.207:9080/getAds/cpc/6/0/50/%s/3232262672/20141022092715613302051844096892271/0/0/0/1/%s/0/0/0/0/debug"
...
if __name__ == "__main__":
    ...
    runner = HTMLTestRunner.HTMLTestRunner(
        stream=fp,
        title=u'列表页计算模块---图书, version = %s' % version,
