...
class ad_calc_search(unittest.TestCase):
    def setUp(self):
        self.URL_NEW = "http://%s/getAds/cpc/10/0/100/%s/184537119/0/0/0/107169205/%s/-/0/0/0/debug"
        self.URL_OLD = "http://%s/getAds/cpc/10/0/100/%s/184537119/0/0/0/107169205/%s/-/0/0/0/debug"
        pass
    @data(*query_list)
