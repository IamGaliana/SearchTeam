...
#auor:dongxiaobing
"""
1.input test data,could skip to "all products" page,and the page is active
2.input test data,could skip to "the specific search" page,and the page is not active
"""
import sys   
